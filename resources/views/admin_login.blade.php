...
<body>
    ...
    <div class="container">
        ...
        <div class="row" style="padding-left:30%; padding-right:30%;">
            ...
            @endif
            <form action="{{ url('admin_login_qry') }}" method="post" enctype="multipart/form-data">
                @csrf
            ...
            <span>If You are a User Then: <a href="user_login" style="text-decoration:none">Login Here</a></span>
        </div>
    </div>
    <hr>
